module.exports.config = {
	...
	hasPermssion: 0,
	credits: "ZiaRein",
	description: "group sex",
	commandCategory: "nsfw",
	usages: `Tag someone or left it blank\n\nHow to use?\n${global.config.PREFIX}gangbang <@tag>\n\nExample:\n${global.config.PREFIX}gangbang @name\n`,
	cooldowns: 5,
	dependencies: {
	  "fs-extra": "",
	  "axios": "",
...
try {
  ...
  const canvas = Canvas.createCanvas(500, 500);
	...
	fs.writeFileSync(path_hiepdam,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_hiepdam, {'highWaterMark': 128 * 1024}), body: "ugh im cumming please stop"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
