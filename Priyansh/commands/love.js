...
module.exports.run = async ({ api, event}) => {
 const { threadID, messageID, senderID } = event;
  ...
  const ZiaRein1 = [
    ...
    "The beginning of love is to let those we love be perfectly themselves, and not to twist them to fit our own image. Otherwise, we love only the reflection of ourselves we find it them Jasper",
