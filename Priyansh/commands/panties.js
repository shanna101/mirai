...
module.exports.run = async({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
    ...
    var callback = () => api.sendMessage({ body: `Anime panties`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, (err, info) => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
